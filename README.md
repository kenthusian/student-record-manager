...
Add New Student: Adds a new student record with validation (unique student_id , non-empty

fields).

View Student Record: Fetches and displays a student's full record by their ID.

Update Student Grades: Updates a student's Math, Science, and English grades (validated 0-

100).

Delete Student Record: Deletes a student record with user confirmation.

Run Analytics Report: Calls the analytics.py  module to print a comprehensive school
